  ...
  return (
    <div className="space-y-6 select-none">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="font-bold text-2xl md:text-3xl text-slate-100 tracking-tight">Tax & SST Reporting</h2>
          <p className="text-xs md:text-sm text-slate-400 mt-1">Malaysian Sales & Services Tax (SST) filing automation & compliance.</p>
        </div>
      ...
      <div className="glass-card bg-gradient-to-r from-indigo-950/40 via-slate-900/60 to-purple-950/40 border border-indigo-500/30 rounded-2xl p-5 md:p-6 shadow-level-1 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <button
          ...
          className="w-full md:w-auto px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 hover:brightness-110 text-white font-semibold text-xs md:text-sm rounded-xl shadow-lg shadow-indigo-600/25 transition-all flex items-center justify-center gap-2 active:scale-98"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <div className="glass-card bg-slate-900/60 rounded-2xl p-5 shadow-level-1 border border-slate-800/80 flex flex-col justify-between h-36 group hover:border-indigo-500/50 transition-all">
          <div className="flex justify-between items-start">
            <span className="text-[11px] font-bold text-slate-400 uppercase tracking-wider">Total Taxable Sales</span>
        ...
        <div className="glass-card bg-slate-900/60 rounded-2xl p-5 shadow-level-1 border border-slate-800/80 flex flex-col justify-between h-36 group hover:border-rose-500/50 transition-all">
          <div className="flex justify-between items-start">
            <span className="text-[11px] font-bold text-slate-400 uppercase tracking-wider">Total SST Payable</span>
        ...
        <div className="glass-card bg-slate-900/60 rounded-2xl p-5 shadow-level-1 border border-slate-800/80 flex flex-col justify-between h-36 group hover:border-emerald-500/50 transition-all">
          <div className="flex justify-between items-start">
            <span className="text-[11px] font-bold text-slate-400 uppercase tracking-wider">Input Tax Credit</span>
        ...
        {/* Card 4: Net SST Due */}
        <div className="glass-card bg-gradient-to-br from-indigo-950/50 to-slate-900/80 rounded-2xl p-5 shadow-level-1 border border-indigo-500/40 flex flex-col justify-between h-36 group hover:border-indigo-400 transition-all">
          <div className="flex justify-between items-start">
            <span className="text-[11px] font-bold text-indigo-400 uppercase tracking-wider">Net SST Due</span>
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1 font-medium">To be remitted to JKDM</p>
          </div>
        </div>
      </div>
      ...
      <div className="glass-card bg-slate-900/60 rounded-2xl shadow-level-1 border border-slate-800/80 overflow-hidden">
        <div className="p-5 border-b border-slate-800/80 flex justify-between items-center">
          <div>
            <h3 className="font-bold text-base md:text-lg text-slate-100">SST Breakdown (JKDM Schedule)</h3>
            <p className="text-xs text-slate-400">Disaggregated sales tax and service tax schedule</p>
          </div>
          <button
            onClick={handleExportTaxSummary}
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-cyan-300 bg-slate-800 hover:bg-slate-700 border border-slate-700 rounded-xl transition-colors"
          >
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-slate-800/50 text-xs md:text-sm text-slate-200">
              <tr className="hover:bg-slate-800/30 transition-colors">
                ...
                <td className="px-6 py-4 text-right text-slate-300">RM 300,000.00</td>
                <td className="px-6 py-4 text-center">
                  <span className="bg-indigo-500/20 text-indigo-300 border border-indigo-500/30 px-2.5 py-0.5 rounded-full font-bold text-xs">
                    10%
                  </span>
                </td>
                <td className="px-6 py-4 text-right font-bold text-slate-100">RM 30,000.00</td>
              </tr>
              <tr className="hover:bg-slate-800/30 transition-colors">
                <td className="px-6 py-4 font-semibold text-slate-100">
                  Services (Cafe Dining, Event Catering, Barista Services)
                </td>
                <td className="px-6 py-4 text-right text-slate-300">RM 150,000.00</td>
                <td className="px-6 py-4 text-center">
                  <span className="bg-indigo-500/20 text-indigo-300 border border-indigo-500/30 px-2.5 py-0.5 rounded-full font-bold text-xs">
                    6%
                  </span>
                </td>
                <td className="px-6 py-4 text-right font-bold text-slate-100">RM 9,000.00</td>
              </tr>
              <tr className="bg-slate-950/40 font-bold">
                <td className="px-6 py-3.5 text-slate-100">Gross Total</td>
                <td className="px-6 py-3.5 text-right text-slate-100">RM 450,000.00</td>
                <td className="px-6 py-3.5 text-center text-slate-500">-</td>
                <td className="px-6 py-3.5 text-right text-slate-100">RM 39,000.00</td>
              </tr>
      ...
      {/* Filing History */}
      <div className="glass-card bg-slate-900/60 rounded-2xl shadow-level-1 border border-slate-800/80 p-5 md:p-6">
        <div className="flex justify-between items-center mb-4">
          <h3 className="font-bold text-base md:text-lg text-slate-100">Filing History</h3>
          <button className="text-xs font-bold text-indigo-400 hover:text-indigo-300 hover:underline flex items-center gap-1">
        ...
        <div className="divide-y divide-slate-800/50">
          {filings.map((filing) => (
            <div key={filing.id} className="py-3.5 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
              <div>
                <h4 className="font-bold text-xs md:text-sm text-slate-100">{filing.period}</h4>
                <p className="text-xs text-slate-400">Submitted on {filing.submissionDate} via MySST Portal</p>
              </div>
              <div className="flex items-center gap-4">
