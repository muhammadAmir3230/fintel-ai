  ...
  return (
    <div className="space-y-6 select-none max-w-4xl">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="font-bold text-2xl md:text-3xl text-slate-800 tracking-tight">Business Settings</h2>
          <p className="text-xs md:text-sm text-slate-600 mt-1">Configure company registration, SST tax parameters, and Copilot AI rules.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <div className="glass-card bg-white/60 rounded-3xl p-6 md:p-8 shadow-level-1 border border-gray-200/80 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs md:text-sm">
            <div>
              <label className="block text-xs font-bold text-slate-600 mb-1">Company / Brand Name</label>
              <input
                type="text"
                value={formData.name}
            ...
            <div>
              <label className="block text-xs font-bold text-slate-600 mb-1">SSM Registration Number</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-xs font-bold text-slate-600 mb-1">Owner / Primary Contact</label>
              <input
                type="text"
        ...
        <div className="glass-card bg-white/60 rounded-3xl p-6 md:p-8 shadow-level-1 border border-gray-200/80 space-y-4">
          ...
          <div className="space-y-3 text-xs md:text-sm">
            <label className="flex items-center justify-between p-3.5 bg-white/60 rounded-2xl border border-gray-200 cursor-pointer hover:border-gray-200 transition-colors">
              <div>
                <span className="font-bold text-slate-600 block">Registered for SST with JKDM</span>
                <span className="text-[11px] text-slate-600">Automatic Form SST-02 bi-monthly calculation</span>
              </div>
              <input
                type="checkbox"
            ...
            <div>
              <label className="block text-xs font-bold text-slate-600 mb-1">Default Service Tax Rate</label>
              <select
              ...
              >
                ...
                <option value={10} className="bg-white text-slate-600">10% - Sales Tax (Goods)</option>
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            className="flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-emerald-600 to-emerald-600 hover:brightness-110 text-slate-900 rounded-xl font-semibold text-xs md:text-sm shadow-lg shadow-emerald-600/25 transition-all active:scale-98"
          >
